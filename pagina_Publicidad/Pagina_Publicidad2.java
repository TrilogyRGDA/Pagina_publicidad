 ...
 */
public class Pagina_Publicidad2 extends JFrame {
	// UID VERSIÓN
	/**
	 * La versión del programa de Pagina_Publicidad es la 2.
	...
	// ------------------------------------------------------------------------------------------------------
	/**
	 * En el método main ejecutamos la ventana principal Pagina_Publicidad2 donde te mostrará publicidad.
	 */
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Pagina_Publicidad2 frame = new Pagina_Publicidad2();
	...
	// ------------------------------------------------------------------------------------------------------
	/**
	 * El constructor se llama a los atributos y métodos necesarios para el funcionamiento de la clase Pagina_Publicidad2.
	 */
	// ----------------------------------------------------------------------------------------
	// PANEL ADMINISTRADOR
	// ----------------------------------------------------------------------------------------
	public Pagina_Publicidad2() {
		setType(Type.UTILITY);
		setResizable(false);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1128, 703); // TAMAÑO DE LA VENTANA PRINCIPAL
		...
		panel_contenedor.setBounds(0, 0, 1119, 663);
		...
		lbl_IMG_Fondo.setBounds(0, 0, 1112, 663);
		...
		// ----------------------------------------------------------------------------------------
		// btnEngranaje_Admin TE REDIRIGE AL ADMINISTRADOR DE TU CUENTA
		// ----------------------------------------------------------------------------------------
		btnEngranaje_Admin = new JButton("");
		btnEngranaje_Admin.setBounds(1080, 0, 32, 32);
		...
		// ----------------------------------------------------------------------------------------
		lbl_Logo = new JLabel("");
		lbl_Logo.setBounds(255, 55, 619, 120);
		// AJUSTAR IMAGEN AL CONTENIDO
		...
		// ----------------------------------------------------------------------------------------
		lbl_TXT_Publicitario = new JLabel("Selecciona el contenido que te apetece ver.");
		lbl_TXT_Publicitario.setHorizontalAlignment(SwingConstants.CENTER);
		lbl_TXT_Publicitario.setBounds(180, 240, 769, 100);
		...
		lbl_TXT_Recomen_Peli.setBounds(100, 425, 719, 150);
		...
		// ----------------------------------------------------------------------------------------
		// LABEL DONDE CONTIENE LA PELICULA MENCIONADA EN "lbl_TXT_Recomen_Peli"
		// ----------------------------------------------------------------------------------------
		...
		lbl_Trailer_Peli.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				// CUANDO PULSAS TE MUESTRA LA PELÍCULA QUE RECOMIENDA EL TEXTO PUBLICITARIO
		...
		lbl_Trailer_Peli.setBounds(889, 393, 169, 230);
		// AJUSTAR IMAGEN AL CONTENIDO
